        ...
        <div>
            ...
            <section className="container">
                <form action="" className="form-box">
                    ...
                    <label htmlFor="dowloadMode" className="label">Música</label>
                    <Dropdown 
                        downloadMode={(downloadMode) => setDownloadMode(downloadMode)}
                        IdforSelectLabel="dowloadMode" 
                        optionLabel="option"
                        optionValue="id"
                        data={[
                            {id: 0, option: 'Não'},
